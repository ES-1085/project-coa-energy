...
```{r}
anim <- ggplot(fuel_type_yearly2, aes(x = Year, y = Emissions, color = as.factor(Year))) +
  geom_point() +
  labs(title = "Scatter Plot of Emissions Over Time") +
...
```
```{r}
anim2 <- ggplot(fuel_type_yearly2, aes(x = Year, y = Emissions)) +
  geom_smooth()+
  geom_point()+
